...
\title{A Tact primer for Solidity developers - part 1}
\author{Vitor Py}
\date{2024-04-08}
...
\section{A simple counter contract}

Let's look at this Simple Counter contract form \href{https://tact-by-example.org/01-a-simple-counter}{Tact by Example}:
...
You may notice there's a \texttt{get} kwyword in the Tact example above. Getters are meant for programatic interaction with DApps or wallets and can't be called by other contracts.
